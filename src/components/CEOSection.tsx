      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="relative">
            <Card className="group hover:shadow-2xl transition-all duration-700 border-0 bg-gradient-to-br from-pink-50/50 to-purple-50/50 hover:-translate-y-2 overflow-hidden">
              <CardContent className="p-0">
                <div className="relative h-96 overflow-hidden">
                  <img
                    src="https://images.unsplash.com/photo-1494790108755-2616b612b977?w=600&h=800&fit=crop&crop=face"
                  ...
                  <div className="absolute top-4 right-4 animate-pulse">
                    <Heart className="w-6 h-6 text-white opacity-70 fill-current" />
                  </div>
                  <div className="absolute bottom-4 left-4 animate-bounce">
                    <Sparkles className="w-5 h-5 text-white opacity-60" />
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-2 gap-6 mt-8">
              <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-pink-50/30 to-purple-50/30">
                <CardContent className="p-6 text-center">
                  ...
                  <h4 className="text-lg font-semibold mb-2">1000+</h4>
              ...
              <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-yellow-50/30 to-orange-50/30">
                <CardContent className="p-6 text-center">
                  ...
                  <h4 className="text-lg font-semibold mb-2">500+</h4>
                  <p className="text-sm text-muted-foreground">Magical Moments</p>
                </CardContent>
              </Card>
            </div>
          </div>
